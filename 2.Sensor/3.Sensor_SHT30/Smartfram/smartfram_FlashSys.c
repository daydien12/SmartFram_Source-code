...
void smartfram_IncrementIdMsg(uint32_t Temp, uint32_t Hum)
{
	...
	Sys_DeviceFlashData_MSG.Temperature = Temp;
	Sys_DeviceFlashData_MSG.Humidity = Hum;
	Sys_DeviceFlashData_MSG.Sensor_ERROR = vr_Sensor_ERROR;
	FS_FlashDevice_WriteMesseger();
...
void FS_FlashDevice_InitMsg(void)
{
	...
	Sys_DeviceFlashData_MSG.Temperature = 0;
	Sys_DeviceFlashData_MSG.Humidity = 0;
	Sys_DeviceFlashData_MSG.Sensor_ERROR = 0;
...
void FS_FlashUpdate_All(void)
{
	...
	FS_FlashUpdate_DeviceKey();
	 vr_Sensor_ERROR =  Sys_DeviceFlashData_MSG.Sensor_ERROR;
}
...
void FS_FlashDevice_Debug(void)
{
	...
	sprintf(buffer_temp, "%d",Sys_DeviceFlashData_MSG.Temperature);
	APP_PPRINTF("Temperature: %s \n"	,buffer_temp);
...
void FS_FlashDevice_ReadMesseger(void)
{
	...
	Sys_DeviceFlashData_MSG.Temperature = TempData->Temperature;
	Sys_DeviceFlashData_MSG.Humidity 		= TempData->Humidity;
	Sys_DeviceFlashData_MSG.Sensor_ERROR = TempData->Sensor_ERROR;
