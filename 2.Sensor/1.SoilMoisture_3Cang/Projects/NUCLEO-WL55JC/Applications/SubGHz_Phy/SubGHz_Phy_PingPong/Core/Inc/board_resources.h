...
/**
  * @brief Pin of Led3
  */
#define SYS_LED3_PIN                                GPIO_PIN_9
/**
  * @brief Port of Led3
  */
#define SYS_LED3_GPIO_PORT                          GPIOA
/**
  * @brief Enable GPIOs clock of Led3
  */
#define SYS_LED3_GPIO_CLK_ENABLE()                  __HAL_RCC_GPIOA_CLK_ENABLE()
/**
  * @brief Disable GPIOs clock of Led3
  */
#define SYS_LED3_GPIO_CLK_DISABLE()                 __HAL_RCC_GPIOA_CLK_ENABLE()

/**  Definition for BSP USER LED 2  **/
/**
  * @brief Pin of Led2
  */
#define SYS_LED2_PIN                                GPIO_PIN_10
/**
  * @brief Port of Led2
  */
...
/**
  * @brief Pin of Led1
  */
#define SYS_LED1_PIN                                GPIO_PIN_11
/**
  * @brief Port of Led1
  */
...
/**
  * @brief Pin of Led3
  */
#define SYS_LED3_PIN                                GPIO_PIN_3
/**
  * @brief Port of Led3
  */
...
/**
  * @brief Pin of Led2
  */
#define SYS_LED2_PIN                                GPIO_PIN_4
/**
  * @brief Port of Led2
  */
#define SYS_LED2_GPIO_PORT                          GPIOB
...
/**
  ...
  */
#define SYS_BUTTON1_PIN                    GPIO_PIN_3
/**
  * @brief Port of Button1
  */
#define SYS_BUTTON1_GPIO_PORT              GPIOC
/**
  * @brief Enable GPIOs clock of Button1
  */
#define SYS_BUTTON1_GPIO_CLK_ENABLE()      __HAL_RCC_GPIOC_CLK_ENABLE()
/**
  * @brief Disable GPIOs clock of Button1
  */
#define SYS_BUTTON1_GPIO_CLK_DISABLE()     __HAL_RCC_GPIOC_CLK_DISABLE()
/**
  * @brief Interrupt number of Button1
  */
#define SYS_BUTTON1_EXTI_IRQn              EXTI3_IRQn
/**
  * @brief Interrupt line of Button1
  */
#define SYS_BUTTON1_EXTI_LINE              EXTI_LINE_3
/**
